...
const ROUTE_MAP: Record<string, Record<Lang, string>> = {
  ...
  socios: { es: 'distribuidores', en: 'distributors' },
  partners: { es: 'distribuidores', en: 'distributors' },
  'por-que-hesa': { es: 'por-que-hesa', en: 'why-hesa' },
  'why-hesa': { es: 'por-que-hesa', en: 'why-hesa' },
