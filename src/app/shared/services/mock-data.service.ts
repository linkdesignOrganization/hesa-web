...
export class MockDataService {
  ...
  private readonly messages: Message[] = [
    ...
    { id: 'm2', name: 'John Mitchell', email: 'j.mitchell@pharmavet-usa.com', phone: '+1 555-0142', type: 'Fabricante', message: 'We are PharmaVet USA, a manufacturer of veterinary biologicals based in Texas. We are looking for distribution partners in Central America and would like to explore a partnership with HESA for the Costa Rican market.', status: 'nuevo', date: '2026-03-17T07:15:00', relativeDate: 'Hace 5 horas' },
    ...
    { id: 'm8', name: 'Akiko Tanaka', email: 'a.tanaka@nipponvet.co.jp', phone: '+81 3-5555-0198', type: 'Fabricante', message: 'We are Nippon Veterinary Pharmaceuticals from Japan. We produce a line of ophthalmic solutions for veterinary use and are interested in entering the Central American market through an established distributor.', status: 'atendido', date: '2026-03-13T15:30:00', relativeDate: 'Hace 4 dias', notes: 'Respondido en ingles. Solicitamos catalogo de productos y registro sanitario.' },
