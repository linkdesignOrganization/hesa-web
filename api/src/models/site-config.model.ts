...
const siteConfigSchema = new Schema<ISiteConfig>(
  {
    ...
    youtube: { type: String },
    metaTitle: { type: bilingualField, default: { es: 'HESA - Fármacos, Alimentos y Equipos Veterinarios', en: 'HESA - Veterinary Pharmaceuticals, Food & Equipment' } },
    metaDescription: { type: bilingualField, default: { es: 'Importación y distribución de fármacos veterinarios, alimentos para animales y equipos veterinarios en Costa Rica. 37+ años de experiencia.', en: 'Import and distribution of veterinary pharmaceuticals, animal food and veterinary equipment in Costa Rica. 37+ years of experience.' } },
    ogImage: { type: String },
